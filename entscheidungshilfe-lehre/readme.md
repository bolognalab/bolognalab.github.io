...
Die Regeln, die festlegen, wie sich die Art der Beantwortung der einzelnen Fragen auf dem Score der verschiedenen Ergebnisse auswirkt, werden in der Datei [autoPopulateScenarios.py](https://github.com/bolognalab/bolognalab.github.io/blob/main/entscheidungshilfe-lehre/autoPopulateScenarios.py) geschrieben. Um die inhaltliche Peer-Review der Regeln ohne Voraussetzung von Programmierkenntnissen zu ermöglichen, sind die Regeln auch in Textform in der Datei [regeln.md](https://github.com/bolognalab/bolognalab.github.io/blob/main/entscheidungshilfe-lehre/dokumentation/regeln.md) enthalten.

Zusätzlich können auf der Seite <https://bolognalab.github.io/entscheidungshilfe-lehre/flow.html> die Regeln in Praxis getestet werden, indem man die Fragen beantwortet und gleich den Einfluss auf die Scores der Ergebnisse sehen kann (Abbildung 5).

![](dokumentation/img_flowScreenshot.png)
*Abbildung 5. Screenshot aus der Seite flow.html*